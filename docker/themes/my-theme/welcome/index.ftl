            ...
            <#elseif bootstrap>
                ...
                <#else>
                    <p class="welcome-message">
                        <img src="welcome-content/alert.png">You need local access to create the initial admin user. <br><br>Open <a href="https://mrusnac2.ngrok.app/auth">https://mrusnac2.ngrok.app/auth</a>
